class ResultsController < ApplicationController
  ...
  def create
    ...
    params[:group_id] = group_id(params, competition_id(params))
  ...
  def update
    ...
    respond_to do |format|
      if @result.update(params.slice(:place, :time, :category_id, :group_id, :runner_id))
  ...
  def result_params
    params.require(:result).permit(:place, :runner_id, :hours, :minutes, :seconds, :category_id, :competition_id,
                                   :competition_name, :date, :location, :country, :groups, :distance_type)
  end
end
